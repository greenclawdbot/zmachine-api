...
export default class GameObject {
    ...
    get name() {
        return zstringToAscii(this.state, this.state.getZString(this.propertyTableAddr + 1), false);
    }
    get parent() {
        return this.state.getObject(this.state._version <= 3
    ...
    get propertyTableAddr() {
        return this.state.getWord(this.objaddr + (this.state._version <= 3 ? 7 : 12));
    }
    hasAttribute(attr) {
        if (this.state._version <= 3) {
            if (attr >= 32) {
